...
test('defines package and release gates around tsdown', () => {
  ...
  assert.match(packageJson.scripts['test:demos'], /build/)
  assert.match(packageJson.scripts['test:demos'], /test:demos:check/)
  assert.match(packageJson.scripts['test:demos:check'], /test:demos:unit/)
  assert.match(packageJson.scripts['test:demos:check'], /typecheck:demos/)
  assert.match(packageJson.scripts['test:demos:check'], /build:demos/)
  ...
  assert.match(packageJson.scripts.prepublishOnly, /publish:check/)
